 ...
 */
package com.roundlink.plugins.mpris
...
import com.roundlink.plugins.mpris.MprisPlugin.MprisPlayer
import com.roundlink.plugins.notifications.NotificationReceiver
import com.roundlink.plugins.systemvolume.SystemVolumePlugin
import com.roundlink.plugins.systemvolume.SystemVolumeProvider
import com.roundlink.plugins.systemvolume.SystemVolumeProvider.Companion.currentProvider
import com.roundlink.plugins.systemvolume.SystemVolumeProvider.ProviderStateListener
...
class MprisMediaSession : OnSharedPreferenceChangeListener, NotificationReceiver.NotificationListener,
    ...
    companion object {
        ...
        private const val MPRIS_MEDIA_SESSION_TAG = "com.roundlink.media_session"
