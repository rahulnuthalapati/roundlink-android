/*
 * ContactsPlugin.java - This file is part of Roundlink's Android App
 ...
 */
package com.roundlink.plugins.contacts
...
import com.roundlink.helpers.ContactsHelper.ContactNotFoundException
import com.roundlink.helpers.ContactsHelper.VCardBuilder
import com.roundlink.helpers.ContactsHelper.uID
...
import com.roundlink.ui.AlertDialogFragment
...
class ContactsPlugin : Plugin() {
    ...
    /**
     * Add custom fields to the vcard to keep track of Roundlink-specific fields
     *
     *
     ...
     * @return The same VCard as was passed in, but now with Roundlink-specific fields
     */
