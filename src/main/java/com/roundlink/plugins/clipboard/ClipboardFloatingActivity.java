...
package com.roundlink.plugins.clipboard;
...
/*
    ...
    adb -d shell pm grant com.roundlink android.permission.READ_LOGS;
    ...
    adb -d shell appops set com.roundlink SYSTEM_ALERT_WINDOW allow;
    # Kill the app, new permissions take effect on restart.
    adb -d shell am force-stop com.roundlink;
