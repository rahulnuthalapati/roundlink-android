...
*/
package com.roundlink.helpers.security
...
import com.roundlink.helpers.DeviceHelper.getDeviceId
import com.roundlink.helpers.RandomHelper
import com.roundlink.helpers.security.RsaHelper.getPrivateKey
import com.roundlink.helpers.security.RsaHelper.getPublicKey
...
object SslHelper {
    ...
    fun initialiseCertificate(context: Context) {
        ...
        if (needsToGenerateCertificate) {
            ...
            nameBuilder.addRDN(BCStyle.OU, "Roundlink")
