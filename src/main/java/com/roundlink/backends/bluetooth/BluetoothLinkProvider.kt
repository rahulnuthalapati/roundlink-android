 ...
 */
package com.roundlink.backends.bluetooth
...
import com.roundlink.backends.BaseLinkProvider
import com.roundlink.Device
import com.roundlink.DeviceInfo
...
import com.roundlink.ui.SettingsFragment
import com.roundlink.extensions.getParcelableArrayCompat
import com.roundlink.extensions.getParcelableCompat
...
class BluetoothLinkProvider(private val context: Context) : BaseLinkProvider() {
    ...
    private inner class ServerRunnable : Runnable {
        ...
        override fun run() {
            serverSocket = try {
                bluetoothAdapter!!.listenUsingRfcommWithServiceRecord("Roundlink", SERVICE_UUID)
            } catch (e: IOException) {
                Log.e("KDEConnect", "Exception", e)
                return
    ...
    private inner class ClientConnect(private val device: BluetoothDevice?) : Runnable {
        ...
        private fun connectToDevice() {
            ...
            try {
                ...
                Log.e("BTLinkProvider/Client", "Could not connect to Roundlink service on " + device!!.address, e)
                return
            } catch (e: SecurityException) {
